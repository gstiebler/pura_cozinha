...
export default async (): Promise<IOrder[]> => {
  return [
    ...
    },
    {
      userId: "userid",
      local: "Prédio 2",
      localComplement: "apt 111",
      comments: "",
      kitchenComments: null,
      status: "PENDING",
      paymentOption: "Cartão",
      telephoneNumber: "42123",
      totalAmount: 8.0,
      items: [
        {
          qty: 1,
    ...
    },
    {
      ...
      statusHistory: [],
      createdOn: new Date("2018-01-08")
    },
    {
      userId: "userid",
      local: "Prédio 2",
      localComplement: "apartamento 501",
      comments: "Bem mais rapido",
      kitchenComments: null,
      status: "PENDING",
      paymentOption: "Cartão",
      telephoneNumber: "94345",
      ...
      statusHistory: [],
      createdOn: new Date("2018-02-01")
    },
    {
      userId: "userid",
      local: "Prédio 2",
      localComplement: "apt 662",
      comments: "Comentario",
      kitchenComments: null,
      status: "PENDING",
      paymentOption: "Cartão",
      ...
      createdOn: new Date("2018-02-04"),
      statusHistory: []
    },
    {
      userId: "userid",
      local: "Prédio 2",
      localComplement: "apt 777",
      ...
      createdOn: new Date("2018-02-05"),
      statusHistory: []
    },
    {
      userId: "userid",
      local: "Prédio 2",
      localComplement: "apt 888",
      comments: "fake",
      kitchenComments: null,
      status: "PENDING",
      paymentOption: "Cartão",
      telephoneNumber: "1111222333",
      totalAmount: 15.0,
      items: [
        {
          qty: 1,
